...
model = torch.load('D:\home\zeewei\projects\\77GRadar\model\cnn\model_dir\model_cnn1\cnn3_272_new.pkl')

data_extractor = feature_extractor.FeatureExtractor()  # 此处全使用默认的文件路径配置
input_data = np.load('D:\home\zeewei\projects\\77GRadar\model\cnn\\test_data_pg\\input_data.npy')
label_data = np.load('D:\home\zeewei\projects\\77GRadar\model\cnn\\test_data_pg\\label_data.npy')
L = len(input_data)

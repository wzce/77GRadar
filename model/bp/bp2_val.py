...
model = torch.load('D:\home\zeewei\projects\\77GRadar\model\\bp\model_dir\\bp2\\bp2_45900.pkl')

# data_extractor = feature_extractor.FeatureExtractor()  # 此处全使用默认的文件路径配置
input_data = np.load('D:\home\zeewei\projects\\77GRadar\model\\bp\\test_data\\bp2.npy')
label_data = np.load('D:\home\zeewei\projects\\77GRadar\model\\bp\\test_data\\bp2.npy')
# data_extractor = feature_extractor.FeatureExtractor()  # 此处全使用默认的文件路径配置

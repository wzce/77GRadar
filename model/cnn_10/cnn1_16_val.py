...
model = torch.load('D:\home\zeewei\projects\\77GRadar\model\cnn_10\model\cnn1\cnn1_1240_70_16.pkl')

# data_extractor = feature_extractor.FeatureExtractor()  # 此处全使用默认的文件路径配置
input_data = np.load('D:\home\zeewei\projects\\77GRadar\model\cnn_10\\test_data\\input_data_cnn1_all_16.npy')
label_data = np.load('D:\home\zeewei\projects\\77GRadar\model\cnn_10\\test_data\\label_data_cnn1_all_16.npy')
# data_extractor = feature_extractor.FeatureExtractor()  # 此处全使用默认的文件路径配置

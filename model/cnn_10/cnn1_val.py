...
model = torch.load('D:\home\zeewei\projects\\77GRadar\model\cnn_10\model\cnn1\cnn1_pg250_new_70_all.pkl')

# data_extractor = feature_extractor.FeatureExtractor()  # 此处全使用默认的文件路径配置
input_data = np.load('D:\home\zeewei\projects\\77GRadar\model\cnn_10\\test_data\\input_data_cnn1_all_32.npy')
label_data = np.load('D:\home\zeewei\projects\\77GRadar\model\cnn_10\\test_data\\label_data_cnn1_all_32.npy')
# data_extractor = feature_extractor.FeatureExtractor()  # 此处全使用默认的文件路径配置

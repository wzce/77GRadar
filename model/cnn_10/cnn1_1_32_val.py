...
model = torch.load('D:\home\zeewei\projects\\77GRadar\model\cnn_10\model\cnn1_1_16\cnn1_1_16150_50.pkl')

# data_extractor = feature_extractor.FeatureExtractor()  # 此处全使用默认的文件路径配置
input_data = np.load('D:\home\zeewei\projects\\77GRadar\model\cnn_10\\test_data\\input_32_cnn1_1_32.npy')
label_data = np.load('D:\home\zeewei\projects\\77GRadar\model\cnn_10\\test_data\\input_32_cnn1_1_32.npy')
# data_extractor = feature_extractor.FeatureExtractor()  # 此处全使用默认的文件路径配置

...
class Net1(nn.Module):
    def __init__(self, INPUT_SIZEINPUT_SIZE):
        ...
        self.out = nn.Sequential(nn.Linear(8, 16),
                                 nn.ReLU(True),
                                 nn.Linear(16, 64),
...
MODEL_SAVE_DIR = 'D:\home\zeewei\projects\\77GRadar\model\cnn_10\model\cnn3\\'
...
def train_playground():
    ...
    #     v = decrease_range_resolution(item)
    ...
    np.save('D:\home\zeewei\projects\\77GRadar\model\cnn\\test_data_pg\\cnn3_input.npy', test_data_input)
    np.save('D:\home\zeewei\projects\\77GRadar\model\cnn\\test_data_pg\\cnn3_label.npy', test_data_label)
